...
class Cms_category_lang extends \Dingedi\TablesTranslation\DgTableTranslatable16
{
    public $controller = 'AdminCmsContent'; // TODO
    public $table = 'cms_category_lang';
    public $object_model = 'CMSCategory';

    public function __construct()
    {
        $primary_key = 'id_cms_category';
    ...
    {
        return $this->l('Categories of pages');
    }
}
